...
from bipedal.assets.bipedal import BIPEDAL_CFG, BIPEDAL_CFG_V3  # isort:skip
...
class BipedalSceneCfg(InteractiveSceneCfg):
    ...
    # cartpole
    robot: ArticulationCfg = BIPEDAL_CFG_V3.replace(prim_path="{ENV_REGEX_NS}/robot")
    # sensors
...
class ActionsCfg:
    ...
    joint_effort = mdp.JointPositionActionCfg(asset_name="robot", joint_names=[".*_hip2thigh", ".*_thigh2calf"], scale=0.25)
...
@configclass
class BipedalEnvCfgV3(ManagerBasedRLEnvCfg):
