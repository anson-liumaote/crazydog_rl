...
from bipedal.assets.bipedal import BIPEDAL_CFG_V5  # isort:skip
...
class BipedalSceneCfg(InteractiveSceneCfg):
    ...
    # cartpole
    robot: ArticulationCfg = BIPEDAL_CFG_V5.replace(prim_path="{ENV_REGEX_NS}/robot")
    # sensors
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        #                     params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip2thigh", ".*_thigh2calf"])})
...
class RewardsCfg:
    ...
    # (2) Failure penalty
    terminating = RewTerm(func=mdp.is_terminated, weight=-100.0)    #-200
    ...
    dof_torques_l2 = RewTerm(func=mdp.joint_torques_l2, weight=-1.0e-4)     # -1.0e-5
    ...
    # -- optional penalties
    flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=-1.0)    # -2.0
...
@configclass
class BipedalEnvCfgV5(ManagerBasedRLEnvCfg):
