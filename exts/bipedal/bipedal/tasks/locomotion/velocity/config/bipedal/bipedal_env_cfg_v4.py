...
from bipedal.assets.bipedal import BIPEDAL_CFG_V4  # isort:skip
...
class BipedalSceneCfg(InteractiveSceneCfg):
    ...
    # cartpole
    robot: ArticulationCfg = BIPEDAL_CFG_V4.replace(prim_path="{ENV_REGEX_NS}/robot")
    # sensors
...
class EventCfg:
    ...
    add_base_mass = EventTerm(
        ...
        params={
            ...
            "mass_distribution_params": (1.08, 3.0),
            "operation": "add",
        },
    )
    ...
    push_robot = EventTerm(
        ...
        params={"velocity_range": {"x": (-0.7, 0.7), "y": (-0.5, 0.5)}},
    )
...
@configclass
class BipedalEnvCfgV4(ManagerBasedRLEnvCfg):
